...
@media (hover: hover) and (pointer: fine) {
  .tabulator.table-striped.table-dark .tabulator-row:nth-child(even):hover {
    background-color: #323539 !important;
  }
  .tabulator.table-striped.table-dark .tabulator-row:nth-child(even):hover .tabulator-cell {
    background-color: inherit;
  }
}
...
@media (hover: hover) and (pointer: fine) {
  html[data-bs-theme=dark] .tabulator.table-striped .tabulator-row:nth-child(even):hover {
    background-color: var(--bs-secondary-bg) !important;
  }
  html[data-bs-theme=dark] .tabulator.table-striped .tabulator-row:nth-child(even):hover .tabulator-cell {
    background-color: inherit;
  }
}
...
.tabulator.table-dark:not(.thead-light) .tabulator-header .tabulator-col.tabulator-frozen-left {
  border-right-color: #4d5154;
}

.tabulator.table-dark:not(.thead-light) .tabulator-header .tabulator-col.tabulator-frozen-right {
  border-left-color: #4d5154;
}

@media (hover: hover) and (pointer: fine) {
  .tabulator.table-dark:not(.thead-light) .tabulator-header .tabulator-col.tabulator-col-sorter-element:hover {
...
.tabulator.table-dark .tabulator-cell.tabulator-frozen-left {
  border-right-color: #4d5154;
}

.tabulator.table-dark .tabulator-cell.tabulator-frozen-right {
  border-left-color: #4d5154;
}
...
.tabulator.table-dark .tabulator-row.tabulator-group {
  background: #323539;
}

.tabulator.table-dark .tabulator-row.tabulator-group span {
  color: #fff;
}

.tabulator.table-dark .tabulator-row .tabulator-data-tree-control {
  border-color: #4d5154;
}

.tabulator.table-dark .tabulator-row .tabulator-data-tree-control .tabulator-data-tree-control-collapse:after {
  background: #fff;
}

.tabulator.table-dark .tabulator-row .tabulator-data-tree-control .tabulator-data-tree-control-expand {
  background: #fff;
}

.tabulator.table-dark .tabulator-row .tabulator-data-tree-control .tabulator-data-tree-control-expand:after {
  background: #fff;
}
...
.tabulator.table-dark .tabulator-footer {
  ...
  color: #fff !important;
  background-color: rgb(44.3716216216, 49.75, 55.1283783784);
}
...
.tabulator.table-dark .tabulator-footer .tabulator-spreadsheet-tabs .tabulator-spreadsheet-tab.tabulator-spreadsheet-tab-active {
  background-color: rgb(55.7432432432, 62.5, 69.2567567568);
}

.tabulator.table-dark .tabulator-footer .tabulator-page {
  border-color: #4d5154;
  background-color: #212529;
}

.tabulator.table-dark .tabulator-footer .tabulator-page.active {
  background-color: rgb(67.1148648649, 75.25, 83.3851351351);
  border-color: rgb(101.3913043478, 106.6583850932, 110.6086956522);
  color: #212529;
}

.tabulator.table-dark .tabulator-footer .tabulator-page:disabled {
  color: #999999;
}

@media (hover: hover) and (pointer: fine) {
  .tabulator.table-dark .tabulator-footer .tabulator-page:not(.disabled):hover {
    background-color: #323539;
    border-color: #323539;
    color: #fff;
  }
...
.tabulator.table-dark .tabulator-footer .tabulator-page-size {
  background-color: #212529;
  border-color: #4d5154;
}

.tabulator.table-dark .tabulator-header .tabulator-col .tabulator-header-filter input,
.tabulator.table-dark .tabulator-header .tabulator-col .tabulator-header-filter select,
.tabulator.table-dark .tabulator-header .tabulator-col .tabulator-header-filter textarea,
.tabulator.table-dark .tabulator-cell.tabulator-editing input,
.tabulator.table-dark .tabulator-cell.tabulator-editing select,
.tabulator.table-dark .tabulator-cell.tabulator-editing textarea {
  color: #fff;
  background-color: #212529;
  border-color: #4d5154;
}

.tabulator.table-dark .tabulator-header .tabulator-col .tabulator-header-filter input:focus,
.tabulator.table-dark .tabulator-header .tabulator-col .tabulator-header-filter select:focus,
.tabulator.table-dark .tabulator-header .tabulator-col .tabulator-header-filter textarea:focus,
.tabulator.table-dark .tabulator-cell.tabulator-editing input:focus,
.tabulator.table-dark .tabulator-cell.tabulator-editing select:focus,
.tabulator.table-dark .tabulator-cell.tabulator-editing textarea:focus {
  border-color: rgb(134, 182.5, 254);
}
...
html[data-bs-theme=dark] .tabulator:not(.thead-light) .tabulator-header .tabulator-col.tabulator-frozen-left {
  border-right-color: var(--bs-border-color);
}

html[data-bs-theme=dark] .tabulator:not(.thead-light) .tabulator-header .tabulator-col.tabulator-frozen-right {
  border-left-color: var(--bs-border-color);
}

@media (hover: hover) and (pointer: fine) {
  html[data-bs-theme=dark] .tabulator:not(.thead-light) .tabulator-header .tabulator-col.tabulator-col-sorter-element:hover {
...
html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-frozen-left {
  border-right-color: var(--bs-border-color);
}

html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-frozen-right {
  border-left-color: var(--bs-border-color);
}
...
html[data-bs-theme=dark] .tabulator .tabulator-row.tabulator-group {
  background: var(--bs-secondary-bg);
}

html[data-bs-theme=dark] .tabulator .tabulator-row.tabulator-group span {
  color: var(--bs-body-color);
}

html[data-bs-theme=dark] .tabulator .tabulator-row .tabulator-data-tree-control {
  border-color: var(--bs-border-color);
}

html[data-bs-theme=dark] .tabulator .tabulator-row .tabulator-data-tree-control .tabulator-data-tree-control-collapse:after {
  background: var(--bs-emphasis-color);
}

html[data-bs-theme=dark] .tabulator .tabulator-row .tabulator-data-tree-control .tabulator-data-tree-control-expand {
  background: var(--bs-emphasis-color);
}

html[data-bs-theme=dark] .tabulator .tabulator-row .tabulator-data-tree-control .tabulator-data-tree-control-expand:after {
  background: var(--bs-emphasis-color);
}
...
html[data-bs-theme=dark] .tabulator .tabulator-footer .tabulator-spreadsheet-tabs .tabulator-spreadsheet-tab.tabulator-spreadsheet-tab-active {
  background-color: var(--bs-secondary-bg);
}
...
html[data-bs-theme=dark] .tabulator .tabulator-footer .tabulator-page:disabled {
  color: var(--bs-tertiary-color);
}

@media (hover: hover) and (pointer: fine) {
  html[data-bs-theme=dark] .tabulator .tabulator-footer .tabulator-page:not(.disabled):hover {
    background-color: var(--bs-secondary-bg);
...
html[data-bs-theme=dark] .tabulator .tabulator-header .tabulator-col .tabulator-header-filter textarea,
html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-editing input,
html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-editing select,
html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-editing textarea {
  color: var(--bs-body-color);
  background-color: var(--bs-body-bg);
  border-color: var(--bs-border-color);
}

html[data-bs-theme=dark] .tabulator .tabulator-header .tabulator-col .tabulator-header-filter input:focus,
html[data-bs-theme=dark] .tabulator .tabulator-header .tabulator-col .tabulator-header-filter select:focus,
html[data-bs-theme=dark] .tabulator .tabulator-header .tabulator-col .tabulator-header-filter textarea:focus,
html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-editing input:focus,
html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-editing select:focus,
html[data-bs-theme=dark] .tabulator .tabulator-cell.tabulator-editing textarea:focus {
...
@media (hover: hover) and (pointer: fine) {
  html[data-bs-theme=dark] .tabulator-menu .tabulator-menu-item:not(.tabulator-menu-item-disabled):hover {
    background: var(--bs-tertiary-bg);
  }
}

html[data-bs-theme=dark] .tabulator-menu .tabulator-menu-item.tabulator-menu-item-submenu::after {
...
html[data-bs-theme=dark] .tabulator-edit-list .tabulator-edit-list-item.active {
  color: var(--bs-emphasis-color);
  background: var(--bs-secondary-bg);
}

html[data-bs-theme=dark] .tabulator-edit-list .tabulator-edit-list-item.active.focused {
  outline: 1px solid var(--bs-border-color);
}

html[data-bs-theme=dark] .tabulator-edit-list .tabulator-edit-list-item.focused {
  outline: 1px solid var(--bs-border-color);
}

@media (hover: hover) and (pointer: fine) {
  html[data-bs-theme=dark] .tabulator-edit-list .tabulator-edit-list-item:hover {
    color: var(--bs-emphasis-color);
    background: var(--bs-tertiary-bg);
  }
}
...
html[data-bs-theme=dark] .tabulator-print-table {
  color: var(--bs-body-color);
}

html[data-bs-theme=dark] .tabulator-print-table .tabulator-print-table-group {
  background: var(--bs-tertiary-bg);
}

html[data-bs-theme=dark] .tabulator-print-table .tabulator-print-table-group span {
  color: var(--bs-body-color);
}
